...
## descriptive tables/figures --- Figure 2  Example petrol station and surrounding competition
...
# map showing distance for example
...
# station level analysis - entry/exit

load(file='exit_data_only_treat.Rda') # here using the full data with traffic not yet adjusted
...
#quarts_p<-table_cell_font(quarts_p, row = 4, column = 2, face = "bold")
...
load(file='entry_data_only_treat.Rda')
...
## margin by competition - Table in Appendix
...
## brand margin by income_cat - Table in Appendix
...
## examine margin distribution for main variables - Table  (Appendix)
...
## mean margin by search and competition (Appendix)
